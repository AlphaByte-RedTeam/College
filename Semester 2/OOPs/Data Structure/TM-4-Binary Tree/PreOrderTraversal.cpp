    ...
    do
    {
        ...
        switch ( option )
        {
            ...
            case 5:
                ...
                preOrder( root ); // BUG: always shows 0.
                // SOLVED!!
                // The bug is solved, the problem is in do while loop
                // It ask for input again and again, and to exit the loop,
                // you need to enter 0. After the end of the loop, it called
                // addData() with value 0. Write the statement on line 103
                // inside the loop to fix the bug.
                printf( "\n\n" );
                break;
